...
Server writes use nonblocking sockets. A write failure, including a slow client that cannot accept more data, disconnects that client. There is no delivery acknowledgement or automatic retry.
